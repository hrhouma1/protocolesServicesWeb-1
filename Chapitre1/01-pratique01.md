### Quiz : Protocoles Réseau et Modèles de Référence
...
9. **Lequel des éléments suivants est un protocole de routage interne qui utilise une conception hiérarchique basée sur des zones ?**
   - a) BGP
   - b) EIGRP
   - c) OSPF
   - d) ICMP
